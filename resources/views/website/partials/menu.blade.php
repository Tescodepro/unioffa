                ...
                <div class="header-top-right">
                    <div class="header-top-contact">
                        <ul>
                            ...
                            <li>
                                <a href="tel:+2348066814330"><i class="far fa-phone-volume"></i> +234 806 681 4330</a>
                                <a href="tel:+2348066552935">| +234 806 655 2935</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <ul class="navbar-nav">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-4 col-md-3">
                                                ...
                                                <ul class="mega-menu-item">
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('team.prochancellor') }}">The
                                                            Pro-Chancellor</a></li>
                                                    <li><a class="dropdown-item" href="#">The Vice-Chancellor</a></li>
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('team.registrar') }}">The Registrar</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4 col-md-3">
                                                ...
                                                <ul class="mega-menu-item">
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('team.council.suraj') }}">Mr. Suraj
                                                            Oyewale</a></li>
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('team.council.abdulateef') }}">Mr. Opeyemi
                                                            Abdulateef</a></li>
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('team.council.abdulrasheed') }}">Mr.
                                                            Abdulrasheed Oyewale</a></li>
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('team.council.akeem') }}">Dr. Akeem
                                                            Oyewale</a></li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu fade-down">
                                ...
                                <li><a class="dropdown-item"
                                        href="{{ route('scholarship.application') }}">Scholarships</a></li>
                                <li><a class="dropdown-item" href="{{ route('application.login') }}">Admission Form</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
