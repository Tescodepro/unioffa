    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <!-- Payment Lockdown Banners -->
                @if(isset($activeLockdown))
                    @if($activeLockdown->deadline->isPast())
                        <div class="card bg-danger border-0 mb-4 text-white shadow-lg overflow-hidden position-relative" style="background: linear-gradient(135deg, #ef4444 0%, #b91c1c 100%); border-radius: 12px;">
                            <div class="position-absolute end-0 top-0 p-3 opacity-10" style="pointer-events: none;">
                                <i class="fas fa-lock" style="font-size: 8rem; transform: rotate(15deg); color: #fff;"></i>
                            </div>
                            <div class="card-body p-4 position-relative">
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                    <div class="d-flex align-items-center gap-3">
                                        <span class="avatar avatar-lg bg-white bg-opacity-20 text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; min-width: 48px;">
                                    ...
                                    <div>
                                        <span class="badge bg-white text-danger fw-bold px-3 py-2 fs-6 rounded-pill shadow-sm">LOCKED</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    @else
                        <div class="card border-0 mb-4 text-white shadow-lg overflow-hidden position-relative" style="background: linear-gradient(135deg, #6366f1 0%, #4338ca 100%); border-radius: 12px;">
                            <div class="position-absolute end-0 top-0 p-3 opacity-10" style="pointer-events: none;">
                                <i class="fas fa-clock" style="font-size: 8rem; transform: rotate(-15deg); color: #fff;"></i>
                            </div>
                            <div class="card-body p-4 position-relative">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($payment->balance > 0)
                                                    ...
                                                    @if ($isRowLocked)
                                                        <button type="button" class="btn btn-sm btn-danger disabled" title="This payment option is locked down.">
                                                            <i class="fas fa-lock me-1"></i> Locked
                                                        </button>
                                                        <div class="small fw-bold text-danger mt-1" style="font-size: 0.75rem;">
                                                            <i class="fas fa-lock"></i> Deadline Passed
                                                        </div>
                                                    @elseif (isset($payment->has_late_penalty) && $payment->has_late_penalty)
