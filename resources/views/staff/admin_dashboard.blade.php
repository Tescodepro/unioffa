                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(optional($student->admissionList)->admission_status !== 'admitted')
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="admitModal{{ $student->id }}" tabindex="-1" aria-labelledby="admitModalLabel{{ $student->id }}" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <strong>Second Choice:</strong> {{ $student->second_choice ?? 'N/A' }}
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label class="form-label">Final Course of Study *</label>
                                                                        <select class="form-select" name="final_course" form="admitForm{{ $student->id }}" required>
