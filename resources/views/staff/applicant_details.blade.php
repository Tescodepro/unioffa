                    ...
                    <div class="card-body">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    @if($application->profile)
                                        ...
                                        <p><strong>State of Origin:</strong> {{ $application->profile->state_of_origin ?? 'N/A' }}
                                        </p>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <p><strong>First Choice:</strong>
                                        {{ $application->user->courseOfStudy?->firstDepartment?->department_name ?? 'N/A' }}</p>
                                    <p><strong>Second Choice:</strong>
                                        {{ $application->user->courseOfStudy?->secondDepartment?->department_name ?? 'N/A' }}
                                    </p>
                                </div>
                            </div>
                        @endif
                        ...
                        @isset($admitRoute)
                            ...
                            <div class="card mb-4 border-{{ $alreadyAdmitted ? 'success' : 'warning' }}">
                                <div
                                    class="card-header bg-{{ $alreadyAdmitted ? 'success' : 'warning' }} {{ $alreadyAdmitted ? 'text-white' : 'text-dark' }} fw-bold">
                                    <i class="ti ti-{{ $alreadyAdmitted ? 'circle-check' : 'user-check' }} me-1"></i>
                                    Admission Decision
                                </div>
                                <div class="card-body">
                                    @if($alreadyAdmitted)
                                        <p class="text-success mb-0">
                                            ...
                                            This applicant has already been admitted to
                                            <strong>{{ optional($application->user->admissionList?->department)->department_name ?? 'a department' }}</strong>.
                                        </p>
                                    @else
