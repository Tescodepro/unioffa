...
@section('title', 'Create Scholarship Setting')
            ...
            <div class="content">
                <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                    <div class="my-auto mb-2">
                        <h3 class="page-title mb-1">Create Scholarship Setting</h3>
                        <nav>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('scholarship-settings.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="application_type" class="form-control" required>
                                        <option value="all" {{ old('application_type') == 'all' ? 'selected' : '' }}>All (UTME & DE)</option>
                                        <option value="utme" {{ old('application_type') == 'utme' ? 'selected' : '' }}>UTME</option>
                                        <option value="direct_entry" {{ old('application_type') == 'direct_entry' ? 'selected' : '' }}>Direct Entry</option>
                                    </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="min_jamb_score" class="form-control" placeholder="200" required value="{{ old('min_jamb_score', 200) }}">
