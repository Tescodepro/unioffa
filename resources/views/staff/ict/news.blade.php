...
@section('content')
            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body table-responsive">
                        <table class="table table-striped align-middle" id="news-table">
                            <thead>
                                <tr>
                                    <th>Image</th>
                                    <th>Title</th>
                            ...
                            <tbody>
                                @forelse($news as $item)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <button class="btn btn-sm btn-outline-primary editNewsBtn" data-id="{{ $item->id }}"
                                                data-title="{{ $item->title }}" data-short_title="{{ $item->short_title }}"
                                                data-slug="{{ $item->slug }}" data-image="{{ $item->image }}"
    ...
    <div class="modal fade" id="addNewsModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form method="POST" action="{{ route('ict.news.store') }}" enctype="multipart/form-data"
                onsubmit="return syncContent('add')">
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="title" id="add_title"
                                    ...
                                    placeholder="Enter full headline" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="short_title"
                                    ...
                                    placeholder="For menus/breadcrumbs" required>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="slug" id="add_slug"
                                    class="form-control bg-light @error('slug') is-invalid @enderror" readonly required>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="file" name="image" class="form-control @error('image') is-invalid @enderror"
                                    accept="image/*" onchange="previewImage(this, 'addImagePreview')" required>
                                <div class="mt-2">
                                    <img id="addImagePreview" src="" class="img-thumbnail d-none"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="border p-2 mb-2 rounded bg-light d-flex gap-2">
                                    <button type="button" class="btn btn-sm btn-outline-secondary fw-bold"
                                        onclick="formatDoc('add', 'bold')" title="Bold">B</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary fst-italic"
                                        onclick="formatDoc('add', 'italic')" title="Italic">I</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary"
                                        onclick="formatDoc('add', 'insertOrderedList')" title="Ordered List"><i
                                            class="ti ti-list-numbers"></i> OL</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary"
                                        onclick="formatDoc('add', 'insertUnorderedList')" title="Bullet List"><i
                                            class="ti ti-list"></i> UL</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" onclick="addLink('add')"
                                        title="Add Link"><i class="ti ti-link"></i> Link</button>
                                </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="mt-2">
                                    <img id="editImagePreview" src="" class="img-thumbnail d-none"
                                        style="max-height: 150px;">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="border p-2 mb-2 rounded bg-light d-flex gap-2">
                                    <button type="button" class="btn btn-sm btn-outline-secondary fw-bold"
                                        onclick="formatDoc('edit', 'bold')" title="Bold">B</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary fst-italic"
                                        onclick="formatDoc('edit', 'italic')" title="Italic">I</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary"
                                        onclick="formatDoc('edit', 'insertOrderedList')" title="Ordered List"><i
                                            class="ti ti-list-numbers"></i> OL</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary"
                                        onclick="formatDoc('edit', 'insertUnorderedList')" title="Bullet List"><i
                                            class="ti ti-list"></i> UL</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" onclick="addLink('edit')"
                                        title="Add Link"><i class="ti ti-link"></i> Link</button>
                                </div>
    ...
    <script>
        ...
        document.querySelectorAll('.editNewsBtn').forEach(btn => {
            btn.onclick = () => {
                ...
                let updateUrl = "{{ route('ict.news.update', ':id') }}";
