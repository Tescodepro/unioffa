                    ...
                    <div class="card-body">
                        <form method="GET" class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="matric_no" class="form-control" placeholder="Search by matric no"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="phone" class="form-control" placeholder="Search by phone number"
                                    value="{{ request('phone') }}">
                            </div>
                                ...
                                @forelse($students as $student)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <form action="{{ route('ict.students.destroy', $student->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
        ...
        <script>
            $(document).ready(function () {
                var table = $('#students-table').DataTable({
                    ...
                    searching: true, // Client side search for current page
                    info: false,
                    ordering: true,
                });
            });
