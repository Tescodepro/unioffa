    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('ict.application-settings.store') }}" method="POST">
                            @csrf
                            <div class="row g-3">
                                {{-- Basic Details --}}
                                <div class="col-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="available_departments[]" class="form-select select2" multiple data-placeholder="Select Departments">
                                        @foreach($departments as $department)
                                            <option value="{{ $department->id }}">{{ $department->department_name }} ({{ $department->faculty->faculty_name ?? 'N/A' }})</option>
                                        @endforeach
                                    </select>
                                </div>
