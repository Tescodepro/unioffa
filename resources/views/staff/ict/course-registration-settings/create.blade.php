...
@section('title', 'Create Course Registration Setting')
            ...
            <div class="content">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                    <div class="my-auto mb-2">
                        <h3 class="page-title mb-1">Create Course Registration Setting</h3>
                        <p class="text-muted mb-0">Add a new deadline and late fee.</p>
                    </div>
                    <div>
                ...
                <div class="row">
                    <div class="col-md-8 mx-auto">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('ict.course-registration-settings.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="mb-3">
                                     ...
                                     <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" name="late_registration_fee" class="form-control" value="0" required>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Excluded Matric Numbers <small>(Optional, comma-separated)</small></label>
                                        <textarea name="excluded_matric_numbers" class="form-control" rows="3" placeholder="MAT/001, MAT/002">{{ old('excluded_matric_numbers') }}</textarea>
