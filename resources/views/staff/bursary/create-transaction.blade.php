        ...
        <script>
            $(document).ready(function () {
                $('#manualTransactionsTable').DataTable({
                    ...
                    buttons: [
                        { extend: 'copy', className: 'btn btn-sm btn-outline-secondary color-white text-white' }, title: 'Manual Transactions'
                        { extend: 'csv', className: 'btn btn-sm btn-outline-secondary color-white text-white' }, title: 'Manual Transactions'
                        { extend: 'excel', className: 'btn btn-sm btn-outline-secondary color-white text-white', title: 'Manual Transactions' },
                        { extend: 'pdf', className: 'btn btn-sm btn-outline-secondary color-white text-white', title: 'Manual Transactions' },
                        { extend: 'print', className: 'btn btn-sm btn-outline-secondary color-white text-white' } title: 'Manual Transactions'
                    ],
                    paging: true,
                    searching: true,
                    info: true,
