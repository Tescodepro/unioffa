            ...
            <div class="content container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <form method="GET" action="{{ route('bursary.reports.faculty') }}"
                        ...
                        <div>
                            <a href="{{ route('bursary.reports.export', ['type' => 'faculty', 'format' => 'pdf']) }}?session={{ $selectedSession }}"
                                class="btn btn-sm btn-danger">
                                <i class="ti ti-file-type-pdf"></i> Export PDF
                            </a>
                            <a href="{{ route('bursary.reports.export', ['type' => 'faculty', 'format' => 'xlsx']) }}?session={{ $selectedSession }}"
                    ...
                    <div class="card shadow-sm mb-4 border-0">
                        <div class="card-header bg-light d-flex justify-content-between align-items-center py-3">
                            ...
                            <button class="btn btn-sm btn-outline-primary" type="button" data-bs-toggle="collapse" 
                                data-bs-target="#collapseFaculty-{{ Str::slug($campusName) }}">
                                <i class="ti ti-arrows-up-down"></i> Toggle Section
                            </button>
                        </div>
                        <div id="collapseFaculty-{{ Str::slug($campusName) }}" class="collapse show">
                            <div class="card-body p-4">
                                @foreach($centers as $centerLabel => $faculties)
