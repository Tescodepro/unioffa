                ...
                <form action="{{ route('bursary.payment-settings.store') }}" method="POST" class="card p-4 shadow-sm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="payment_type" class="form-control" placeholder="e.g. School Fees"
                                required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="matric_number" class="form-control"
                                placeholder="Enter matric number if for one student">
                        ...
                        <div class="col-md-4 mb-3 installment-section d-none">
                            ...
                            <input type="number" name="number_of_instalment" id="number_of_instalment" min="1"
                                max="9" class="form-control" value="1">
                        </div>
