                        ...
                        <div class="card-body">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="datetime-local" name="closing_date" class="form-control @error('closing_date') is-invalid @enderror" value="{{ old('closing_date', \Carbon\Carbon::parse($latePaymentSetting->closing_date)->format('Y-m-d\TH:i')) }}" required>
                                    @error('closing_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="excluded_matric_numbers" class="form-control @error('excluded_matric_numbers') is-invalid @enderror" 
                                        rows="3" placeholder="Enter matric numbers separated by commas (e.g., MAT/001, MAT/002)">{{ old('excluded_matric_numbers', is_array($latePaymentSetting->excluded_matric_numbers) ? implode(', ', $latePaymentSetting->excluded_matric_numbers) : '') }}</textarea>
