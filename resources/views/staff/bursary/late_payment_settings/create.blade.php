                        ...
                        <div class="col-lg-8">
                            <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                                <div class="card-header bg-white border-0 py-3 d-flex align-items-center">
                                    ...
                                    <h6 class="mb-0 fw-bold">Financial Penalty Rules</h6>
                                </div>
                                <div class="card-body bg-white pt-2">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-text x-small">Penalty will increase to this amount after the Tier 2 deadline.</div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="card-body bg-white pt-2">
                                    <div class="mb-0">
                                        ...
                                        <textarea name="excluded_matric_numbers" class="form-control border-0 bg-light @error('excluded_matric_numbers') is-invalid @enderror" 
                                            rows="4" placeholder="Enter matric numbers separated by commas or new lines...">{{ old('excluded_matric_numbers') }}</textarea>
                                        <div class="form-text x-small text-info mt-2">
                                            <i class="ti ti-info-circle"></i> Listed students will <strong>never</strong> be charged this penalty.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 border-top border-4 border-primary">
                                ...
                                <div class="card-body bg-white">
                                    <div class="mb-0">
                                        ...
                                        <div class="alert alert-warning border-0 bg-warning bg-opacity-10 mt-3 p-2 rounded-3 mb-0">
                                            <p class="x-small text-dark mb-0">
                                                <i class="ti ti-alert-circle-filled me-1"></i> Original fee cannot be paid after this time.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                                ...
                                <div class="card-body bg-white">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="form-text x-small">Empty = All Modes</div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select name="student_type[]" class="form-select select2-multi" multiple="multiple">
                                            @foreach ($programmes as $programme)
                                                <option value="{{ $programme }}" {{ in_array($programme, old('student_type', [])) ? 'selected' : '' }}>
                                                    {{ $programme }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="level[]" class="form-select select2-multi" multiple="multiple">
                                            @foreach ($levels as $level)
                                                <option value="{{ $level }}" {{ in_array($level, old('level', [])) ? 'selected' : '' }}>
                                                    Level {{ $level }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <select name="admission_session[]" class="form-select select2-multi" multiple="multiple">
                                            @foreach ($sessions as $sess)
                                                <option value="{{ $sess }}" {{ in_array($sess, old('admission_session', [])) ? 'selected' : '' }}>
                                                    {{ $sess }}
                                                </option>
                                            @endforeach
                                        </select>
